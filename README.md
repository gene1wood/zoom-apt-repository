...
* [Fork this repo in GitHub](https://github.com/gene1wood/zoom-apt-repository/fork)
...
* Why do I need to fork the repo?
  * The reason you need your own fork (instead of just using this upstream
    gene1wood/zoom-apt-repository repo) is because GitHub bills for large file
    storage (the Zoom deb file) and bandwidth to download it (when you do an
    apt upgrade). As a result, if everyone used the upstream gene1wood/zoom-apt-repository
...
* Is this secure and safe to use?
  * By forking the code into your own repo and creating your own GPG signing
    key, you remove the ability for the upstream gene1wood/zoom-apt-repository to
